...
[![Project Status: Active](https://img.shields.io/badge/Project%20Status-Active-brightgreen.svg)](https://github.com/tombstonepup/Poster-AR-WebXR)
[![Platform: WebXR](https://img.shields.io/badge/Platform-WebXR-blue.svg)](https://immersive-web.github.io/webxr/)
...
- **XR Framework**: [WebXR Device API](https://developer.mozilla.org/en-US/docs/Web/API/WebXR_Device_API)
...
Alternatively, you can use any static file server like `live-server` or `http-server`:
```bash
npx live-server
```
...
- [Google WebXR Documentation](https://developers.google.com/ar/develop/webxr/hello-webxr)
